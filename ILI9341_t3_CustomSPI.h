...
#ifndef ILI9341_t3_H_
#define _ILI9341_t3_H_
...
#error "Sorry, ILI9341_t3_CustomSPI does not work with Teensy LC.  Use Adafruit_ILI9341."
#elif defined(__AVR__)
#error "Sorry, ILI9341_t3_CustomSPI does not work with Teensy 2.0 or Teensy++ 2.0.  Use Adafruit_ILI9341."
#endif
...
extern unsigned long ILI9341_SPICLOCK;
extern unsigned long ILI9341_SPICLOCK_READ;
...
class ILI9341_t3_CustomSPI : public Print
{
  public:
	ILI9341_t3_CustomSPI(uint8_t _CS, uint8_t _DC, uint8_t _RST = 255, uint8_t _MOSI=11, uint8_t _SCLK=13, uint8_t _MISO=12);
    void Selectable_SPICLOCK_SET(unsigned long Selectable_ILI9341_SPICLOCK, unsigned long Selectable_ILI9341_SPICLOCK_READ); 
	void begin(void);
...
// T4
	...
	void beginSPITransaction(unsigned long clock = ILI9341_SPICLOCK) __attribute__((always_inline)) {
...
// you #include ILI9341_t3_CustomSPI.h.
#ifndef _ADAFRUIT_GFX_H
class Adafruit_GFX_Button {
public:
	Adafruit_GFX_Button(void) { _gfx = NULL; }
	void initButton(ILI9341_t3_CustomSPI *gfx, int16_t x, int16_t y,
		uint8_t w, uint8_t h,
